...
extension VeloWidgetTester on WidgetTester {
  ...
  Future<void> pumpVeloWidget<T extends Velo<dynamic>>(
    ...
    if (wrapInMaterialApp) {
      testWidget = MaterialApp(home: testWidget);
    }
  ...
  Finder findVeloBuilder<T extends Velo<dynamic>>() => find.byWidgetPredicate(
      (widget) => widget is VeloBuilder<T, dynamic>,
    );

  /// Finds a VeloListener widget by its Velo type.
  Finder findVeloListener<T extends Velo<dynamic>>() => find.byWidgetPredicate(
      (widget) => widget is VeloListener<T, dynamic>,
    );

  /// Finds a VeloConsumer widget by its Velo type.
  Finder findVeloConsumer<T extends Velo<dynamic>>() => find.byWidgetPredicate(
      (widget) => widget is VeloConsumer<T, dynamic>,
    );
